...
4. Octan98");
        ...
        public static void PrintByStatus(ref List<VehicleInGarage> m_ArrayVehicle)
        {
            ...
            {
                if (vehicles.MyStatus == VehicleInGarage.Status.Repair)
                {
            ...
            foreach (VehicleInGarage vehicles in m_ArrayVehicle)
            {
                if (vehicles.MyStatus == VehicleInGarage.Status.Fixed)
                {
                    Console.WriteLine(string.Format("{0}) {1}", index, vehicles.MyVehicle.LicenseNumber));
                    index++;
                }
            ...
            foreach (VehicleInGarage vehicles in m_ArrayVehicle)
            {
                if (vehicles.MyStatus == VehicleInGarage.Status.Paid)
                {
                    Console.WriteLine(string.Format("{0}) {1}", index, vehicles.MyVehicle.LicenseNumber));
                    index++;
                }
        ...
        public static void ChangeStatus(ref string i_LicenseNumber, VehicleInGarage.Status i_NewStatus)
        {
            VehicleInGarage m_Vehicle;
